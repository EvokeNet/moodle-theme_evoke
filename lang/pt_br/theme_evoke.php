...
$string['pluginname'] = 'Evoke';
$string['configtitle'] = 'Evoke';
$string['choosereadme'] = 'Evoke é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['cachedef_fontawesomeevokeiconmapping'] = 'Definição de cache dos ícones do tema';
...
$string['privacy:metadata:preference:themeevokesettings_fonttype'] = 'Preferências do usuário para tipo de fonte.';
$string['privacy:metadata:preference:themeevokesettings_enableaccessibilitytoolbar'] = 'Preferências do usuário para habilitar a barra de acessibilidade.';
...
$string['privacy:themeevokesettings_fonttype'] = 'A preferência atual para o tipo de fonte é: {$a}.';
$string['privacy:themeevokesettings_enableaccessibilitytoolbar'] = 'A preferência atual para habilitar a barra de acessibilidade é para exibi-lá';
