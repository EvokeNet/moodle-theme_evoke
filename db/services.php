...
/**
 * Theme evoke functions and service definitions.
 *
 * @package   theme_evoke
...
$functions = array(
    'theme_evoke_fontsize' => array(
        'classname' => 'theme_evoke\api\accessibility',
        'classpath' => 'theme_evoke/classes/api/accessibility.php',
        'methodname' => 'fontsize',
        'description' => 'Increase or decrease the site font size.',
        'type' => 'write',
        'ajax' => true
    ),
    'theme_evoke_sitecolor' => array(
        'classname' => 'theme_evoke\api\accessibility',
    ...
    'theme_evoke_savethemesettings' => array(
        'classname' => 'theme_evoke\api\accessibility',
    ...
    'theme_evoke_getthemesettings' => array(
        'classname' => 'theme_evoke\api\accessibility',
