...
/**
 * The evoke theme does not store any data.
 *
 * @copyright  2018 Willian Mano - http://conecti.me
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    const FONTTYPE = 'themeevokesettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'themeevokesettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:themeevokesettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:themeevokesettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                ...
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:themeevokesettings_enableaccessibilitytoolbar', 'theme_evoke', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_evoke', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_evoke', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:themeevokesettings_fonttype', 'theme_evoke', $fonttype)
            );
        }
    }
}
