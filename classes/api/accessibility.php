...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themeevokesettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themeevokesettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettinggsavedsuccessfully', 'theme_evoke'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themeevokesettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themeevokesettings_enableaccessibilitytoolbar', false)
        ];
    }
