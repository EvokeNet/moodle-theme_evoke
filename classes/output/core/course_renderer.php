...
use theme_evoke\util\extras;

/**
 * Renderers to align Evoke's course elements to what is expect
 *
 * @package    theme_evoke
    ...
    protected function course_card_footer(core_course_list_element $course) {
        ...
        if (isloggedin()) {
            ...
            $content .= html_writer::link(new moodle_url('/course/view.php', ['id' => $course->id]),
                get_string('access', 'theme_evoke'), ['class' => 'card-link btn btn-primary']);
