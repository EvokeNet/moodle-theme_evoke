...
$THEME->scss = function($theme) {
    return theme_evoke_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_evoke_get_extra_scss';
$THEME->prescsscallback = 'theme_evoke_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_evoke_get_precompiled_css';
$THEME->yuicssmodules = [];
