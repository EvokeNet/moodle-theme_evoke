...
/**
 * A two column layout for the evoke theme.
 *
 * @package   theme_evoke
...
$usercourses = \theme_evoke\util\extras::user_courses_with_progress($user);
...
$templatecontext['user']->profilepicture = \theme_evoke\util\extras::get_user_picture($user, 100);
...
$competencyplans = \theme_evoke\util\extras::get_user_competency_plans($user);
$templatecontext['hascompetencyplans'] = (count($competencyplans)) ? true : false;
$templatecontext['competencyplans'] = $competencyplans;

$templatecontext['headerbuttons'] = \theme_evoke\util\extras::get_mypublic_headerbuttons($context, $user);

echo $OUTPUT->render_from_template('theme_evoke/mypublic', $templatecontext);
